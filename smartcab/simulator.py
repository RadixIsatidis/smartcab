        ...
        if self.log_metrics:
            ...
            if a.learning:
                if self.optimized: # Whether the user is optimizing the parameters and decay functions
                    self.log_filename = os.path.join("logs", "sim_improved-learning-cos-00025-alpha-25.csv")
                    self.table_filename = os.path.join("logs","sim_improved-learning-cos-00025-alpha-25.txt")
                else:
                    self.log_filename = os.path.join("logs", "sim_default-learning-cos-00025-alpha-25.csv")
                    self.table_filename = os.path.join("logs","sim_default-learning-cos-00025-alpha-25.txt")

                self.table_file = open(self.table_filename, 'wb')
            else:
                self.log_filename = os.path.join("logs", "sim_no-learning-cos-00025-alpha-25.csv")
